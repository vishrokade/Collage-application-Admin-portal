...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    private EditText updateTeacherName,updateTeacherEmail,updateTeacherPost,updateTeacherSubject;
    private Button deleteTeacherBtn,updateTeacherBtn;

    private String name,email,post, subject,image;
        ...
        uploadTask.addOnCompleteListener(UpdateTeacherActivity.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    //pd.dismiss();
                    Toast.makeText(UpdateTeacherActivity.this, "Image not Uploaded", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
